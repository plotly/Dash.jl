...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}}());hljs.registerLanguage("xml",function(){"use strict";return function(e){var n={
...
relevance:0}},{begin:"\\n\\n",starts:{subLanguage:[],endsWithParent:!0}}]}}}());hljs.registerLanguage("julia",function(){"use strict";return function(e){
...
}],n.contains=a.contains,a}}());hljs.registerLanguage("json",function(){"use strict";return function(n){var e={
...
aliases:["jldoctest"]}]}}}());hljs.registerLanguage("ruby",function(){"use strict";return function(e){
var n="[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",a={
